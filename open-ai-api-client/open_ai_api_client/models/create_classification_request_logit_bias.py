...
T = TypeVar("T", bound="CreateClassificationRequestLogitBias")


@attr.s(auto_attribs=True)
class CreateClassificationRequestLogitBias:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        create_classification_request_logit_bias = cls()

        create_classification_request_logit_bias.additional_properties = d
        return create_classification_request_logit_bias

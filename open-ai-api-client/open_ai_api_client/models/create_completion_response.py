...
if TYPE_CHECKING:
    ...
    from ..models.create_completion_response_usage import CreateCompletionResponseUsage
...
class CreateCompletionResponse:
    ...
    Attributes:
        ...
        usage (Union[Unset, CreateCompletionResponseUsage]):
    """
    ...
    model: str
    choices: List["CreateCompletionResponseChoicesItem"]
    usage: Union[Unset, "CreateCompletionResponseUsage"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_usage, Unset):
            ...
            usage = CreateCompletionResponseUsage.from_dict(_usage)

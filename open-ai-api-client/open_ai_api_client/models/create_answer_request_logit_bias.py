...
T = TypeVar("T", bound="CreateAnswerRequestLogitBias")


@attr.s(auto_attribs=True)
class CreateAnswerRequestLogitBias:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        create_answer_request_logit_bias = cls()

        create_answer_request_logit_bias.additional_properties = d
        return create_answer_request_logit_bias

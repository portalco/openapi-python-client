...
class CreateImageVariationRequest:
    ...
    Attributes:
        ...
        size (Union[Unset, None, CreateImageVariationRequestSize]): The size of the generated images. Must be one of
            `256x256`, `512x512`, or `1024x1024`. Default: CreateImageVariationRequestSize.VALUE_2. Example: 1024x1024.
        response_format (Union[Unset, None, CreateImageVariationRequestResponseFormat]): The format in which the
            generated images are returned. Must be one of `url` or `b64_json`. Default:
            CreateImageVariationRequestResponseFormat.URL. Example: url.
    ...
    size: Union[Unset, None, CreateImageVariationRequestSize] = CreateImageVariationRequestSize.VALUE_2
    response_format: Union[
        Unset, None, CreateImageVariationRequestResponseFormat
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        size: Union[Unset, None, CreateImageVariationRequestSize]
        if _size is None:
            size = None
        ...
        response_format: Union[Unset, None, CreateImageVariationRequestResponseFormat]

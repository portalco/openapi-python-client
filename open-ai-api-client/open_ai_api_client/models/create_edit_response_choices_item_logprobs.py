...
if TYPE_CHECKING:
    from ..models.create_edit_response_choices_item_logprobs_top_logprobs_item import (
        CreateEditResponseChoicesItemLogprobsTopLogprobsItem,
    )


T = TypeVar("T", bound="CreateEditResponseChoicesItemLogprobs")


@attr.s(auto_attribs=True)
class CreateEditResponseChoicesItemLogprobs:
    """
    Attributes:
        tokens (Union[Unset, List[str]]):
        token_logprobs (Union[Unset, List[float]]):
        top_logprobs (Union[Unset, List['CreateEditResponseChoicesItemLogprobsTopLogprobsItem']]):
        text_offset (Union[Unset, List[int]]):
    """

    tokens: Union[Unset, List[str]] = UNSET
    token_logprobs: Union[Unset, List[float]] = UNSET
    top_logprobs: Union[Unset, List["CreateEditResponseChoicesItemLogprobsTopLogprobsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for top_logprobs_item_data in _top_logprobs or []:
            top_logprobs_item = CreateEditResponseChoicesItemLogprobsTopLogprobsItem.from_dict(top_logprobs_item_data)

            top_logprobs.append(top_logprobs_item)

        text_offset = cast(List[int], d.pop("text_offset", UNSET))

        create_edit_response_choices_item_logprobs = cls(
            tokens=tokens,
        ...
        create_edit_response_choices_item_logprobs.additional_properties = d
        return create_edit_response_choices_item_logprobs

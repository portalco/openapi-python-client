...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ListFilesResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListFilesResponse]:
    return Response(

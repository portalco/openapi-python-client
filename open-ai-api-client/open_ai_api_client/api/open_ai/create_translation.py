...
def _get_kwargs(
    *,
    ...
    url = "{}/audio/translations".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CreateTranslationResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CreateTranslationResponse]:
    return Response(

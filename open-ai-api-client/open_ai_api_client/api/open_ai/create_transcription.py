...
def _get_kwargs(
    *,
    ...
    url = "{}/audio/transcriptions".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CreateTranscriptionResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CreateTranscriptionResponse]:
    return Response(
